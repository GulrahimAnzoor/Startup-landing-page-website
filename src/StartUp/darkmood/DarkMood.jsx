...
const DarkMood = () => {
  ...
  // To persist theme between page reloads
  useEffect(() => {
  ...
  return (
    <div className="fixed flex items-center justify-center bg-[#333333] rounded dark:bg-gray-900 z-[99999] shadow-1 dark:shadow-box-dark bottom-10 right-10 h-11 w-11">
      <label htmlFor="themeSwitcher" className="inline-flex items-center cursor-pointer" aria-label="themeSwitcher">
        <input
          type="checkbox"
          id="themeSwitcher"
          className="sr-only"
        ...
        />
        <span className="block text-gray-100 dark:hidden">
          {/* Light Mode Icon */}
        ...
        <span className="hidden text-gray-100 dark:block">
          {/* Dark Mode Icon */}
          <svg className="fill-current" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_2172_3070)">
              ...
              <path d="M4.23751 12C4.23751 11.55 3.86251 11.1375 3.37501 11.1375H1.5C1.05 11.1375 0.637508 11.5125 0.637508 12C0.637508 12.45 1.01251 12.8625 1.5 12.8625H3.41251C3.86251 12.8625 4.23751 12.4875 4.23751 12Z"></path>
            </g>
          </svg>
        </span>
      </label>
