    ...
    <>
      <section className="lg:flex lg:w-full text-white">
        ...
        <a href="#" class="absolute z-40 flex h-20 w-20 items-center justify-center rounded-full bg-primary md:h-[100px] md:w-[100px] ">
              <span class="absolute top-0 right-0 z-[-1] h-full w-full animate-ping rounded-full  bg-primary bg-opacity-20 delay-30 duration-1000"></span>
...
// bg-primary bg-opacity-20 delay-30 duration-1000